...
var (
	// E2E tests are written with the support of ginkgo and ginkgo tests may contain Labels.
	// if a ginkgo test contains a label, then add a label
	// label -> label (ginkgo label)

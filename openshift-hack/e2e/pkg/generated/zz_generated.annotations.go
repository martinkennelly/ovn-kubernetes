...
var AppendedAnnotations = map[string]string{
	...
	"BGP: Pod to external server when default podNetwork is advertised when a client ovnk pod targeting an external server is created tests are run towards the external agnhost echo server": "[Disabled:Unimplemented]",
	...
	"Kubevirt Virtual Machines duplicate IP validation should fail when creating second VM with duplicate static IP": "[Disabled:Unimplemented]",
	...
	"Network Segmentation ClusterUserDefinedNetwork CRD Controller pod connected to ClusterUserDefinedNetwork CR & managed NADs cannot be deleted when being used": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation ClusterUserDefinedNetwork CRD Controller should create NAD according to spec in each target namespace and report active namespaces": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation ClusterUserDefinedNetwork CRD Controller should create NAD in new created namespaces that apply to namespace-selector": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation ClusterUserDefinedNetwork CRD Controller when CR is deleted, should delete all managed NAD in each target namespace": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation ClusterUserDefinedNetwork CRD Controller when namespace-selector is mutated should create NAD in namespaces that apply to mutated namespace-selector": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation ClusterUserDefinedNetwork CRD Controller when namespace-selector is mutated should delete managed NAD in namespaces that no longer apply to namespace-selector": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation Sync perform east/west traffic between nodes following OVN Kube node pod restart L2 with custom network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation Sync perform east/west traffic between nodes following OVN Kube node pod restart L2": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation Sync perform east/west traffic between nodes following OVN Kube node pod restart L3": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation UDN Pod should react to k8s.ovn.org/open-default-ports annotations changes": "[Disabled:Unimplemented]",

	"Network Segmentation UserDefinedNetwork CRD Controller for L2 secondary network pod connected to UserDefinedNetwork cannot be deleted when being used": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation UserDefinedNetwork CRD Controller for L2 secondary network should create NetworkAttachmentDefinition according to spec": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation UserDefinedNetwork CRD Controller for L2 secondary network should delete NetworkAttachmentDefinition when UserDefinedNetwork is deleted": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation UserDefinedNetwork CRD Controller for primary UDN without required namespace label should be able to create pod and it will attach to the cluster default network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation UserDefinedNetwork CRD Controller for primary UDN without required namespace label should not be able to update the namespace and add the UDN label": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation UserDefinedNetwork CRD Controller for primary UDN without required namespace label should not be able to update the namespace and remove the UDN label": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation a user defined primary network created using ClusterUserDefinedNetwork can perform east/west traffic between nodes two pods connected over a L2 primary UDN with custom network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using ClusterUserDefinedNetwork can perform east/west traffic between nodes two pods connected over a L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using ClusterUserDefinedNetwork can perform east/west traffic between nodes two pods connected over a L3 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using ClusterUserDefinedNetwork creates a networkStatus Annotation with UDN interface L2 primary UDN with custom network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using ClusterUserDefinedNetwork creates a networkStatus Annotation with UDN interface L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using ClusterUserDefinedNetwork creates a networkStatus Annotation with UDN interface L3 primary UDN": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation a user defined primary network created using ClusterUserDefinedNetwork isolates overlapping CIDRs with L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation a user defined primary network created using NetworkAttachmentDefinitions can perform east/west traffic between nodes two pods connected over a L2 primary UDN with custom network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using NetworkAttachmentDefinitions can perform east/west traffic between nodes two pods connected over a L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using NetworkAttachmentDefinitions can perform east/west traffic between nodes two pods connected over a L3 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using NetworkAttachmentDefinitions creates a networkStatus Annotation with UDN interface L2 primary UDN with custom network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using NetworkAttachmentDefinitions creates a networkStatus Annotation with UDN interface L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using NetworkAttachmentDefinitions creates a networkStatus Annotation with UDN interface L3 primary UDN": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation a user defined primary network created using NetworkAttachmentDefinitions isolates overlapping CIDRs with L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation a user defined primary network created using UserDefinedNetwork can perform east/west traffic between nodes two pods connected over a L2 primary UDN with custom network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using UserDefinedNetwork can perform east/west traffic between nodes two pods connected over a L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using UserDefinedNetwork can perform east/west traffic between nodes two pods connected over a L3 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using UserDefinedNetwork creates a networkStatus Annotation with UDN interface L2 primary UDN with custom network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using UserDefinedNetwork creates a networkStatus Annotation with UDN interface L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using UserDefinedNetwork creates a networkStatus Annotation with UDN interface L3 primary UDN": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation a user defined primary network created using UserDefinedNetwork isolates overlapping CIDRs with L2 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network created using UserDefinedNetwork isolates overlapping CIDRs with L3 primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation a user defined primary network doesn't cause network name conflict": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation when primary network exist, ClusterUserDefinedNetwork status should report not-ready": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation when primary network exist, UserDefinedNetwork status should report not-ready": "[openshift/ovn-kubernetes/parallel]",
	...
	"Network Segmentation: Default network multus annotation ValidatingAdmissionPolicy protection should prevent adding, modifying and removing the default-network annotation on existing pods": "[Disabled:Unimplemented]",

	"Network Segmentation: Default network multus annotation when added with static IP and MAC to a pod belonging to primary UDN should create the pod with the specified static IP and MAC address": "[Disabled:Unimplemented]",
	...
	"Network Segmentation: Network Policies on a user defined primary network pods within namespace should be isolated when deny policy is present in L2 dualstack primary UDN with custom network": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation: Network Policies on a user defined primary network pods within namespace should be isolated when deny policy is present in L2 dualstack primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation: Network Policies on a user defined primary network pods within namespace should be isolated when deny policy is present in L3 dualstack primary UDN": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation: Preconfigured Layer2 UDN duplicate IP validation with primary UDN layer 2 pods should fail when creating second pod with duplicate static IP IPv4 duplicate": "[Disabled:Unimplemented]",

	"Network Segmentation: Preconfigured Layer2 UDN duplicate IP validation with primary UDN layer 2 pods should fail when creating second pod with duplicate static IP IPv6 duplicate": "[Disabled:Unimplemented]",

	"Network Segmentation: Preconfigured Layer2 UDN should respect network configuration Layer2 basic configuration": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation: Preconfigured Layer2 UDN should respect network configuration Layer2 with custom subnets": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation: Preconfigured Layer2 UDN should respect network configuration Layer2 with inverted gateway/management IPs": "[openshift/ovn-kubernetes/parallel]",

	"Network Segmentation: services on a user defined primary network should be reachable through their cluster IP, node port and load balancer L2 primary UDN with custom network, cluster-networked pods, NodePort service": "[Disabled:Unimplemented]",
	...
	"Services when a nodePort service targeting a pod with hostNetwork:false is created when tests are run towards the agnhost echo service queries to the nodePort service shall work for TCP": "[Disabled:Unimplemented]",

	"Services when a nodePort service targeting a pod with hostNetwork:false is created when tests are run towards the agnhost echo service queries to the nodePort service shall work for UDP": "[Disabled:Unimplemented]",

	"Services when a nodePort service targeting a pod with hostNetwork:true is created when tests are run towards the agnhost echo service queries to the nodePort service shall work for TCP": "[Disabled:Unimplemented]",

	"Services when a nodePort service targeting a pod with hostNetwork:true is created when tests are run towards the agnhost echo service queries to the nodePort service shall work for UDP": "[Disabled:Unimplemented]",

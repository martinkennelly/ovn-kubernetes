module github.com/ovn-org/ovn-kubernetes/openshift-hack/e2e
...
require (
	...
	github.com/coreos/butane v0.18.0 // indirect
	...
	github.com/k8snetworkplumbingwg/ipamclaims v0.5.1-alpha // indirect
